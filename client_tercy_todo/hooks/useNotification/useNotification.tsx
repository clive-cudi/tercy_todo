...
import { NotificationsCtx, notificationCtx_Props, NotificationsCtxTypes } from "../../context";
...
export function useNotification(): useNotificationReturns{
    const {notifications, setNotifications} = useContext(NotificationsCtx) as notificationCtx_Props;
    ...
    function updateNotifications(params: NotificationsCtxTypes): NotificationsCtxTypes {
        if (params){
            setNotifications({
